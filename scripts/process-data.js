 ...
 *
 * Avoids `leftover + chunk` string concatenation + `.split('\\n')`: that builds
 * deep ConsStrings and forces V8 to flatten ~hundreds of MB in one split,
 * which OOMs at the CI heap limit (see Runtime_StringSplit / SlowFlatten).
 * Instead: scan Buffers for 0x0a, decode only complete lines to small strings.
 */
